...
// This script will help set up the database with various connection string formats
...
const connectionFormats = [
  {
    name: 'Direct Connection with plain password',
    url: 'postgresql://postgres:2112Danpei2112@db.vzavjwkspqmqshmcwdyj.supabase.co:5432/postgres'
  },
  {
    name: 'Pooler Connection with plain password',
    url: 'postgres://postgres:2112Danpei2112@aws-0-ap-southeast-1.pooler.supabase.com:6543/postgres'
  },
  {
    name: 'Direct Connection with URL encoded password',
    url: 'postgresql://postgres:2112Danpei2112@db.vzavjwkspqmqshmcwdyj.supabase.co:5432/postgres'
  },
  {
    name: 'Pooler Connection with URL encoded password',
    url: 'postgres://postgres:2112Danpei2112@aws-0-ap-southeast-1.pooler.supabase.com:6543/postgres'
  }
];
...
`;
  ...
  fs.writeFileSync('SUPABASE-SETUP-INSTRUCTIONS.md', instructions);
  log('Created SUPABASE-SETUP-INSTRUCTIONS.md with detailed instructions', 'green');
}
...
PORT=3000`;
    ...
    log('2. Your password is correct: @Danpei2112', 'yellow');
    log('3. Your network allows connection to Supabase', 'yellow');
    log('', 'reset');
    log('See SUPABASE-SETUP-INSTRUCTIONS.md for manual setup steps.', 'blue');
  }
