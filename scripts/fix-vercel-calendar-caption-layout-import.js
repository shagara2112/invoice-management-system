// 🔧 Fix Vercel Calendar Caption Layout Import Script
// This script will help fix the caption layout comparison in calendar component by importing CaptionLayout
...
function fixCalendarComponent() {
  log('🔧 Fixing calendar component caption layout import...', 'blue');
  ...
  if (checkFileExists(calendarPath)) {
    ...
    const fixedContent = calendarContent
      // Add CaptionLayout to the import statement
      .replace(
        /import { DayPicker } from "react-day-picker"/g,
    ...
    log('✓ Calendar component caption layout import fixed', 'green');
  } else {
...
`;
  ...
  fs.writeFileSync('VERCEL-CALENDAR-CAPTION-LAYOUT-IMPORT-FIX-INSTRUCTIONS.md', instructions);
  log('✓ Deployment instructions created', 'green');
}

function main() {
  log('🔧 Fix Vercel Calendar Caption Layout Import Script', 'bright');
  log('===============================================', 'bright');
  log('');
  ...
  log('', 'reset');
  log('✅ Calendar component caption layout import fixed successfully', 'green');
  log('', 'reset');
  ...
  log('6. Check VERCEL-CALENDAR-CAPTION-LAYOUT-IMPORT-FIX-INSTRUCTIONS.md for detailed solutions', 'blue');
  log('', 'reset');
